...
import com.example.sanatkitabm.databinding.ActivityArtBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.equals("new")) {
            ...
            binding.painterNameText.setEnabled(false);
            ...
            try {
                ...
                while (cursor.moveToNext()) {
                    ...
                    binding.painterNameText.setText(cursor.getString(artistNameIx));
